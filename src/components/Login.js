...
const Login = () => {
  ...
  return (
    <Box style={{ backgroundImage: 'url(https://picsum.photos/seed/login-bg/1600/900)', backgroundSize: 'cover', height: '100vh', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
